...
.LBB27:
	...
	jmp	.L195
.L196:
	.loc 6 57 76 discriminator 3
	movq	32(%rbp), %rax
	movq	16(%rax), %rdx
	.loc 6 57 83 discriminator 3
	leaq	0(,%rbx,8), %rax
	addq	%rdx, %rax
	.loc 6 57 66 discriminator 3
	leaq	0(,%rbx,8), %rcx
	movq	-8(%rbp), %rdx
	addq	%rcx, %rdx
	.loc 6 57 83 discriminator 3
	movq	(%rax), %rax
	.loc 6 57 70 discriminator 3
	movq	%rax, (%rdx)
	.loc 6 57 55 discriminator 3
	addq	$1, %rbx
.L195:
	.loc 6 57 46 discriminator 1
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 57 9 discriminator 1
	cmpq	%rax, %rbx
	jb	.L196
.LBE27:
	.loc 6 59 18
...
.LCFI163:
	...
	testq	%rax, %rax
	je	.L203
	.loc 6 106 363 discriminator 1
	movq	32(%rbp), %rax
	movq	16(%rax), %rax
	.loc 6 106 5 discriminator 1
	movq	(%rax), %rbx
	jmp	.L204
.L203:
	.loc 6 106 5 is_stmt 0 discriminator 2
	movl	$0, %ebx
.L204:
	.loc 6 106 5 discriminator 4
	movl	$0, %ecx
	call	get_level_debug
	movq	%rbx, 40(%rsp)
	movl	$106, 32(%rsp)
	...
	movl	$0, %ecx
	call	debug_print
	.loc 6 107 12 is_stmt 1 discriminator 4
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 107 7 discriminator 4
	testq	%rax, %rax
	je	.L205
	.loc 6 107 31 discriminator 1
	movq	32(%rbp), %rax
	movq	16(%rax), %rax
	.loc 6 107 38 discriminator 1
	movq	(%rax), %rax
	jmp	.L206
.L205:
	.loc 6 108 16
...
.LCFI169:
	...
	testq	%rax, %rax
	je	.L208
	.loc 6 119 364 discriminator 1
	movq	32(%rbp), %rax
	movq	16(%rax), %rdx
	.loc 6 119 376 discriminator 1
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 119 371 discriminator 1
	salq	$3, %rax
	subq	$8, %rax
	addq	%rdx, %rax
	.loc 6 119 5 discriminator 1
	movq	(%rax), %rbx
	jmp	.L209
.L208:
	.loc 6 119 5 is_stmt 0 discriminator 2
	movl	$0, %ebx
.L209:
	.loc 6 119 5 discriminator 4
	movl	$0, %ecx
	call	get_level_debug
	movq	%rbx, 40(%rsp)
	movl	$119, 32(%rsp)
	...
	movl	$0, %ecx
	call	debug_print
	.loc 6 120 12 is_stmt 1 discriminator 4
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 120 7 discriminator 4
	testq	%rax, %rax
	je	.L210
	.loc 6 120 31 discriminator 1
	movq	32(%rbp), %rax
	movq	16(%rax), %rdx
	.loc 6 120 43 discriminator 1
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 120 38 discriminator 1
	salq	$3, %rax
	subq	$8, %rax
	addq	%rdx, %rax
	movq	(%rax), %rax
...
.LBB28:
	...
	jmp	.L215
.L216:
	.loc 6 138 63 discriminator 3
	movq	32(%rbp), %rax
	movq	16(%rax), %rdx
	.loc 6 138 70 discriminator 3
	movq	-8(%rbp), %rax
	salq	$3, %rax
	addq	%rdx, %rax
	.loc 6 138 53 discriminator 3
	movq	-8(%rbp), %rdx
	leaq	0(,%rdx,8), %rcx
	movq	-16(%rbp), %rdx
	addq	%rcx, %rdx
	.loc 6 138 70 discriminator 3
	movq	(%rax), %rax
	.loc 6 138 57 discriminator 3
	movq	%rax, (%rdx)
	.loc 6 138 42 discriminator 3
	addq	$1, -8(%rbp)
.L215:
	.loc 6 138 33 discriminator 1
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 138 5 discriminator 1
	cmpq	%rax, -8(%rbp)
	jb	.L216
.LBE28:
	.loc 6 140 5
...
.LBB29:
	...
	jmp	.L223
.L224:
	.loc 6 174 93 discriminator 3
	movq	32(%rbp), %rax
	movq	16(%rax), %rdx
	.loc 6 174 100 discriminator 3
	movq	-8(%rbp), %rax
	salq	$3, %rax
	addq	%rdx, %rax
	.loc 6 174 78 discriminator 3
	movq	(%rax), %rax
	.loc 6 174 9 discriminator 3
	movq	(%rax), %rdx
	movq	-8(%rbp), %rax
	movq	%rdx, %r8
	movq	%rax, %rdx
	...
	addq	$1, -8(%rbp)
.L223:
	.loc 6 173 34 discriminator 1
	movq	32(%rbp), %rax
	movq	(%rax), %rax
	.loc 6 173 5 discriminator 1
	cmpq	%rax, -8(%rbp)
	jb	.L224
.LBE29:
	.loc 6 176 5
...
.LC163:
	.ascii "%c\12\0"
.LC164:
	.ascii "Lista enlazada: \0"
	.align 8
.LC165:
	.ascii "Lista enlazada despues de eliminar nodos: \0"
.LC166:
	.ascii "pop_back: %zu\12\0"
.LC167:
	.ascii "push_back: %zu\12\0"
.LC168:
	.ascii "posicion: %zu\12\0"
.LC169:
	.ascii "last position: %zu\12\0"
.LC170:
	.ascii "ID 4 existe\0"
.LC171:
	.ascii "Nodo con ID 4 existe\0"
.LC172:
	.ascii "Nodo con ID no 4 existe\0"
.LC173:
	.ascii "ID no 4 existe\0"
.LC174:
	.ascii "lista no vacia\0"
.LC175:
	.ascii "lista vacia\0"
.LC176:
	.ascii "size del vector: %zu\12\0"
	.text
	.globl	main
...
.L355:
.LBB39:
	.loc 8 21 27 discriminator 3
	call	createLinkedList
	movq	%rax, -176(%rbp)
	.loc 8 22 9 discriminator 3
	movq	-176(%rbp), %rdx
	movq	-56(%rbp), %rax
	movq	%rax, %rcx
	call	insertNode
.LBE39:
	.loc 8 19 32 discriminator 3
	addl	$1, -4(%rbp)
.L354:
	.loc 8 19 5 discriminator 1
	movl	-4(%rbp), %eax
	cmpl	-44(%rbp), %eax
	jl	.L355
.LBE38:
...
.L358:
.LBB43:
	.loc 8 31 32 discriminator 3
	movl	$4, %ecx
	call	malloc
	movq	%rax, -168(%rbp)
	.loc 8 32 23 discriminator 3
	movl	-8(%rbp), %eax
	imull	-48(%rbp), %eax
	movl	%eax, %edx
	.loc 8 32 33 discriminator 3
	movl	-12(%rbp), %eax
	addl	%eax, %edx
	.loc 8 32 19 discriminator 3
	movq	-168(%rbp), %rax
	movl	%edx, (%rax)
	.loc 8 33 13 discriminator 3
	movq	-168(%rbp), %rdx
	movq	-160(%rbp), %rax
	movq	%rax, %rcx
	call	insertNode
.LBE43:
	.loc 8 29 39 discriminator 3
	addl	$1, -12(%rbp)
.L357:
	.loc 8 29 9 discriminator 1
	movl	-12(%rbp), %eax
	cmpl	-48(%rbp), %eax
	jl	.L358
.LBE42:
.LBE41:
	.loc 8 26 32 discriminator 2
	addl	$1, -8(%rbp)
.L356:
	.loc 8 26 5 discriminator 1
	movl	-8(%rbp), %eax
	cmpl	-44(%rbp), %eax
	jl	.L359
.LBE40:
...
.LBE46:
	...
	cmpq	$0, -24(%rbp)
	jne	.L362
	.loc 8 48 9 discriminator 2
	leaq	.LC147(%rip), %rcx
	call	printf
.LBE45:
	.loc 8 38 32 discriminator 2
	addl	$1, -16(%rbp)
.L360:
	.loc 8 38 5 discriminator 1
	movl	-16(%rbp), %eax
	cmpl	-44(%rbp), %eax
	jl	.L363
.LBE44:
...
.LBE49:
	...
	cmpq	$0, -40(%rbp)
	jne	.L366
	.loc 8 63 9 discriminator 2
	movq	-128(%rbp), %rax
	movq	%rax, %rcx
	call	freeLinkedList
.LBE48:
	.loc 8 52 32 discriminator 2
	addl	$1, -28(%rbp)
.L364:
	.loc 8 52 5 discriminator 1
	movl	-28(%rbp), %eax
	cmpl	-44(%rbp), %eax
	jl	.L367
.LBE47:
...
.Letext0:
	...
	.file 21 "C:/TDM-GCC-64/x86_64-w64-mingw32/include/processenv.h"
